...
export const adminAPI = {
  ...
  getStatusDistribution: () => api.get('/admin/stats/status-distribution'),
  getSeries: (period = 'week') => api.get(`/admin/stats/series?period=${period}`),
  getGeo: () => api.get('/admin/stats/geo'),
